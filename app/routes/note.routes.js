...
app.get('/getnote/:id',middleware.validateToken,redis.noteCache,note.getNoteById);
...
app.get('/getlabel/:id',middleware.validateToken,redis.labelCache,label.getLabelById);
